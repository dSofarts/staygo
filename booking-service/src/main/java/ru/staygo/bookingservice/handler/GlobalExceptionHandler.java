package ru.staygo.bookingservice.handler;
...
import ru.staygo.bookingservice.api.response.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ErrorResponse handleIllegalArgumentException(SecurityException ex, HttpServletRequest request) {
    return new ErrorResponse(
